...
const dictEn: Dict = {
  ...
  "results.poweredBy.model2": "Powered by Model 2 (ResNet-152V2) • Trained by Edward Choi",
  ...
  "results.poweredBy.model6": "Powered by Model 6 (Chronic Lung Risk / COPD) • LungLens clinical team",
  ...
  "results.provenance.hybridBanner.bothModels":
    "Models 1 and 6 used live classifiers on this run. The attention overlay and some report text may still use mock or rule-based scaffolding.",
  "results.provenance.hybridBanner.model1Only":
    "Model 1 used a live classifier. Model 6 (COPD tabular) did not run as a loaded neural model on this run (mock or rules). Findings, attention overlay, and doctor-question hints may still be mock or rule-based.",
  "results.provenance.hybridBanner.model2Only":
    "Model 6 (COPD tabular) ran on this upload. Model 1 did not run as a loaded X-ray classifier (mock or rules). Findings, attention overlay, and doctor-question hints may still be mock or rule-based.",
  ...
  "results.provenance.section.model2_result": "Model 6 — Chronic Lung Risk (COPD)",
  ...
  "results.provenance.nested.stageUsesMock": "Model {n} uses mock data.",
  ...
  "results.provenance.impact.model2": "Model 6 — Chronic Lung Risk (COPD)",
  ...
  "results.provenance.impact.model6": "Model 2 — ResNet-152V2 (Edward)",
...
const dictHant: Dict = {
  ...
  "results.poweredBy.model2": "由模型 2（ResNet-152V2）提供 · Edward Choi 訓練",
  ...
  "results.poweredBy.model6": "由模型 6（慢性肺部風險／COPD）提供 · LungLens 臨床團隊",
  ...
  "results.provenance.section.model2_result": "模型 6 — 慢性肺部風險（COPD）",
  ...
  "results.provenance.nested.stageUsesMock": "模型 {n} 使用模擬資料。",
  ...
  "results.provenance.impact.model2": "模型 6 — 慢性肺部風險（COPD）",
  ...
  "results.provenance.impact.model6": "模型 2 — ResNet-152V2（Edward）",
...
const dictHans: Dict = {
  ...
  "results.poweredBy.model2": "由模型 2（ResNet-152V2）提供 · Edward Choi 训练",
  ...
  "results.poweredBy.model6": "由模型 6（慢性肺部风险／COPD）提供 · LungLens 临床团队",
  "results.complianceImportant": "重要提示",
  "results.pdfXray": "原始 X 光",
  ...
  "results.provenance.section.model1_result": "模型 1 — ResNet-50",
  "results.provenance.section.model2_result": "模型 6 — 慢性肺部风险（COPD）",
  ...
  "results.provenance.nested.stageUsesMock": "模型 {n} 使用模拟数据。",
  ...
  "results.provenance.impact.model1": "模型 1 — ResNet-50",
  "results.provenance.impact.model2": "模型 6 — 慢性肺部风险（COPD）",
  "results.provenance.impact.model3": "模型 3 — DenseNet-121",
  "results.provenance.impact.model4_swint": "模型 4 — Swin Transformer",
  "results.provenance.impact.model5": "模型 5 — DenseNet-121 (H5)",
  "results.provenance.impact.model6": "模型 2 — ResNet-152V2（Edward）",
