...
const dictEn: Dict = {
  ...
  "upload.pipeline.model2": "Running Model 2 (Chronic Lung Risk / COPD) from your questionnaire…",
  ...
  "results.pdfSection.clinicalAssessment": "Model 2 — Clinical Patient Assessment",
  ...
  "results.poweredBy.model2": "Powered by Model 2 (Chronic Lung Risk / COPD) • Trained by Edward Choi",
  ...
  "results.model2Clinical.unavailable":
    "Model 2 unavailable (complete the clinical questionnaire to run COPD screening).",
  ...
  "results.model2": "Model 2 — Chronic Lung Risk (COPD)",
  ...
  "results.provenance.section.model2_result": "Model 2 — Chronic Lung Risk (COPD)",
  ...
  "results.provenance.impact.model2": "Model 2 — Chronic Lung Risk (COPD)",
...
const dictHant: Dict = {
  ...
  "upload.pipeline.model2": "以模型 2（慢性肺部風險／COPD）依問卷資料運算中…",
  ...
  "results.pdfSection.clinicalAssessment": "模型 2 — 臨床病患評估",
  ...
  "results.poweredBy.model2": "由模型 2（慢性肺部風險／COPD）提供 · Edward Choi 訓練",
  ...
  "results.model2Clinical.unavailable": "模型 2 無法使用（請先完成臨床問卷以執行 COPD 篩檢）。",
  ...
  "results.model2": "模型 2 — 慢性肺部風險（COPD）",
  ...
  "results.provenance.hybridBanner.model2Only":
    "模型 2 使用即時分類模型；模型 1 此輪未以已載入的神經模型執行（模擬或規則）。發現區塊、關注圖與醫師提問提示仍可能是模擬或規則型。",
  "results.provenance.hybridBanner.fallback":
  ...
  "results.provenance.section.model2_result": "模型 2 — 慢性肺部風險（COPD）",
  ...
  "results.provenance.impact.model2": "模型 2 — 慢性肺部風險（COPD）",
...
const dictHans: Dict = {
  ...
  "upload.pipeline.model2": "使用模型 2（慢性肺部风险／COPD）根据问卷数据运算中…",
  ...
  "results.pdfSection.clinicalAssessment": "模型 2 — 临床患者评估",
  "results.modelBadge.model1": "模型 1 ✓",
  "results.modelBadge.model2": "模型 2 ✓",
  "results.modelBadge.model3": "模型 3 ✓",
  "results.modelBadge.model4": "模型 4 ✓",
  ...
  "results.poweredBy.model2": "由模型 2（慢性肺部风险／COPD）提供 · Edward Choi 训练",
  ...
  "results.model2Clinical.unavailable": "模型 2 不可用（请先完成临床问卷以运行 COPD 筛查）。",
  ...
  "results.pipelineTitle": "模型流程摘要",
  "results.model1": "模型 1 — ResNet-50",
  "results.model2": "模型 2 — 慢性肺部风险（COPD）",
  "results.model3DenseNet": "模型 3 — DenseNet-121",
  ...
  "results.provenance.section.model1_result": "模型 1 — ResNet-50",
  "results.provenance.section.model2_result": "模型 2 — 慢性肺部风险（COPD）",
  ...
  "results.provenance.hybridBanner.model2Only":
    "模型 2 使用实时分类模型；模型 1 本轮未以已加载的神经网络模型运行（模拟或规则）。发现板块、关注图与医生提问提示仍可能是模拟或基于规则。",
  "results.provenance.hybridBanner.fallback":
